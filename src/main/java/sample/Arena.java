...
public class Arena {
    ...
    private void play() {
        ...
        newLabel.setLayoutX(GRID_WIDTH / 2);
        newLabel.setLayoutY(GRID_WIDTH / 2);
        newLabel.setMinWidth(GRID_WIDTH / 2); newLabel.setMaxWidth(GRID_WIDTH / 2); newLabel.setMinHeight(GRID_WIDTH / 2); newLabel.setMaxHeight(GRID_WIDTH / 2); newLabel.setStyle("-fx-border-color: black;");
        newLabel.setText("*");
        newLabel.setBackground(new Background(new BackgroundFill(Color.BLUE,
        CornerRadii.EMPTY, Insets.EMPTY))); paneArena.getChildren().addAll(newLabel);
    }
